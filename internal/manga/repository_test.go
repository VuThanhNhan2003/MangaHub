...
func setupTestRepo(t *testing.T) *Repository {
	...
	_, err = db.Exec(`
		...
		VALUES 
			('test-manga-1', 'Test Manga 1', 'Test Author 1', ?, 'ongoing', 100, 'Test description 1', 2020),
			('test-manga-2', 'Test Manga 2', 'Test Author 2', ?, 'completed', 50, 'Test description 2', 2019)
